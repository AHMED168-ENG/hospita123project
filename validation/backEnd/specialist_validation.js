...
const AddSpecialist_validation = () => {
  return [
    check("name")
      .notEmpty()
      .withMessage("You must enter the name of the department"),
    check("description")
      .notEmpty()
      .withMessage("You must enter a section description name"),
    check("image")
      ...
      .withMessage("You must enter the image section")
      .custom((value, { req }) => {
      ...
      .withMessage(`Images must have jpg , jpeg , png , gif , svg`)
      .custom(async (value, { req }) => {
        req.files.forEach((element) => {
